...
<!-- Hotjar Tracking Code for https://francobernal.net/ -->
    <script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:2916487,hjsv:6};
...
<body>
    ...
    <div id="app">
        <div class="bar-contact">
            ...
            <div>
                <a target=" _blank"
                onclick="sumStadistic('email')" href="mailto:{{ $contactos->email }}" class="bar-email">
                {{ $contactos->email }}</a>
                <a target="_blank" onclick="sumStadistic('whatsapp')"
    ...
    <footer class="py-6 ">
        <div class='columns is-mobile is-gapless is-multiline'>
            <div class='column centrar-full is-4-fullhd is-4-desktop  is-12-tablet  is-12-mobile'
                ...
                <a href="{{ route('welcome') }}"><img src="{{ json_decode($page->img)->logo_img }}"
                        class="centrar" style="width:70% !important" alt=""></a>
            </div>
            <div class='column is-4-fullhd is-4-desktop  is-12-tablet  is-12-mobile' style='padding:5px !important;'>
                ...
                <a onclick="sumStadistic('email')" href="mailto:{{ $contactos->email }}" target="_blank"
                    ...
                    <img style="float:left; " class="mx-2" width="20px"
                ...
                <a target="_blank" onclick="sumStadistic('linkedin')"
                    href="https://www.linkedin.com/in/{{ $contactos->linkedin }}" style="padding:25px 0 !important;">
                    <img style="float:left; " class="mx-2" width="20px"
            ...
            <div class='column is-4-fullhd is-4-desktop  is-12-tablet  is-12-mobile centrar-full'
                style='padding:5px !important;'>
