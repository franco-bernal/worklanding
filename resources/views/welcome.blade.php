...
@section('content')
    ...
    background: linear-gradient(144deg, rgba(2,0,2,0.919502835313813) 51%, rgba(70,131,205,0) 100%, rgba(167,67,132,1) 9985%), url('{{ $notice->background }}');">
        ...
        @empty
            <div class="noticia"
                style="background:linear-gradient(rgba(0, 0, 0, 0.747), rgba(0, 1, 65, 0.747)), url('https://images.pexels.com/photos/270348/pexels-photo-270348.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940');">
                <h3>Tecnologías disponibles</h3>
                <p>Nuevas tecnologías disponibles</p>
                <a href="#" class="btn-solid">Ir</a>
            </div>
            <div class="noticia"
                style="background:linear-gradient(rgba(0, 0, 0, 0.747), rgba(0, 1, 65, 0.747)), url('https://images.pexels.com/photos/802024/pexels-photo-802024.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940')">
            ...
            <div class="noticia"
                style="background-image:linear-gradient(rgba(0, 0, 0, 0.747), rgba(0, 1, 65, 0.747)), url('https://midu.dev/images/wallpapers/web-technologies-4k-wallpaper.png');">
            ...
            <div class="noticia"
                style="background-image:linear-gradient(rgba(0, 0, 0, 0.747), rgba(0, 1, 65, 0.747)), url('https://images.pexels.com/photos/5836/yellow-metal-design-decoration.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940')">
                <h3>Portafolios</h3>
    ...
    <div class='columns is-mobile is-gapless is-multiline promo-block'>
        <div class='column is-6-fullhd is-6-desktop  is-12-tablet  is-12-mobile block1 promo centrar-full'>
            ...
            <img src="{{ json_decode($page->img)->logo_img }}" class="centrar" style="width:70% !important"
                alt="">
        </div>
    ...
    <div class='columns is-mobile is-gapless is-multiline ' id="contact-div">
        <a onclick="sumStadistic('email')" href="mailto:{{ $contactos->email }}" target="_blank"
            class='email column is-4-fullhd is-4-desktop  is-12-tablet  is-12-mobile' style="padding:25px 0 !important;">
            <img class="centrar" width="40px"
        ...
        <a target="_blank" onclick="sumStadistic('whatsapp')" href="https://wa.me/{{ $contactos->whatsapp }}"
            class='whatsapp column is-4-fullhd is-4-desktop  is-12-tablet  is-12-mobile' style="padding:25px 0 !important;">
            <img class="centrar" width="40px"
        ...
        <a target="_blank" onclick="sumStadistic('linkedin')"
            href="https://www.linkedin.com/in/{{ $contactos->linkedin }}"
            class='linkedin column is-4-fullhd is-4-desktop  is-12-tablet  is-12-mobile' style="padding:25px 0 !important;">
            <img class="centrar" width="40px"
            ...
            @forelse($blog_noticias as $noticia)
                <div class='column is-4-fullhd is-4-desktop  is-12-tablet  is-12-mobile'>
                    <div class="blog_noticia"
                        style="background-image: linear-gradient(332deg, rgba(0,0,0,0.5777661406359419) 52%, rgba(255,255,255,0.23602944595807074) 54%, rgba(167,67,132,1) 9985%), url('{{ $noticia->header_img }}') !important;">
