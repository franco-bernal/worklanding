...
<div class='columns is-mobile is-gapless is-multiline promo-block'>
    <div class='column is-6-fullhd is-6-desktop  is-12-tablet  is-12-mobile block1 promo centrar-full'>
        <!-- <h2>{{ json_decode($page->text)->header_sub_text }} - <img src="https://www.frontec.cl/images/icono_web.png" width="30"></h2>
        ...
        <img src="{{ json_decode($page->img)->logo_img }}" class="centrar" style="width:70% !important" alt="promo">
    </div>
...
<div class='columns is-mobile is-gapless is-multiline  viewTecnologies2' id="tecnologias">
    ...
    <div class='column is-8-fullhd is-8-desktop  is-12-tablet  is-12-mobile viewTecnologies'>
        ...
        <div class="tecnyTarget">
            <div>
                <img class="centrar" src="{{ $tecny->img_logo }}" style="height:40px !important;" alt="logo tecno">
