...
@section('content')
    ...
    <div class='columns is-mobile is-gapless is-multiline ciudad' id="productos">
        ...
        <div class='column centrar-full is-4-fullhd is-4-desktop  is-12-tablet  is-12-mobile ' style="color: #363636;">
            <h2>Produc<span class="subraya">tos</span> y <br> cooperaciones</h2>
        </div>
            ...
            @forelse($blog_noticias as $noticia)
                <div class='column is-4-fullhd is-4-desktop  is-12-tablet  is-12-mobile'>
                    <div class="blog_noticia"
                        style="background-image: linear-gradient(90deg,rgb(18 111 63 / 63%) 0%, var(--color-b)), url('{{ $noticia->header_img }}') !important;">
